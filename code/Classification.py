...
df = pd.read_csv(r'C:\Users\cleme\Documents\1HonoursProject\Code\dataset_clean_lemmatized_2.csv', encoding='utf-8') #read the dataframe with pre-processed tweets
...
def sentiment_scores(sentence):
    ...
    if sentiment_dict['compound'] < -0.60:
        ...
        sentiment = '3'
    elif sentiment_dict['compound'] <= 0.60:
        sentiment = '4'
    else:
        sentiment = '5'
    return sentiment
...
#df.to_csv(r'code\dataset_clean.csv')
...
#Write the changes to csv file
df.to_csv(r'C:\Users\cleme\Documents\1HonoursProject\Code\dataset_clean_lemmatized_5cat.csv')